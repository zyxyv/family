 ...
 */
final class Version20220106081445 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE social_user (social_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_C282052DFFEB5B27 (social_id), INDEX IDX_C282052DA76ED395 (user_id), PRIMARY KEY(social_id, user_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
